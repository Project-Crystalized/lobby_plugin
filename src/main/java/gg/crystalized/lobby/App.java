...
public enum App {
    ...
    TextureSetting("ui/scn3/settings/pig_hunt", useCases.Set, new useCases[]{useCases.Settings}, Component.translatable("crystalized.shardcore.settings.textures").color(WHITE).decoration(ITALIC, false), 41, "textures"),
